...
namespace ArnoldVinkCode
{
    public partial class AVProcess
    {
        ...
        public static IntPtr Detail_WindowHandleMainByProcessId(int targetProcessId, bool checkVisibility)
        {
            try
            {
        ...
        public static IntPtr Detail_WindowHandleMainByThreadId(int targetThreadId, bool checkVisibility)
        {
            try
            {
                foreach (IntPtr windowHandle in Detail_WindowHandlesByThreadId(targetThreadId))
                {
                    try
                    {
                        if (Check_WindowHandleValid(windowHandle, true, checkVisibility))
        ...
        public static IntPtr Detail_WindowHandleMainByAppUserModelId(string targetAppUserModelId, bool checkVisibility)
        {
            try
            {
                foreach (IntPtr windowHandle in Detail_WindowHandlesByAppUserModelId(targetAppUserModelId))
                {
                    try
                    {
                        if (Check_WindowHandleValid(windowHandle, true, checkVisibility))
        ...
        public static IntPtr Detail_ProcessHandleByProcessId(int targetProcessId)
        {
            try
            {
        ...
        public static DateTime Detail_ProcessStartTimeByProcessHandle(IntPtr processHandle)
        {
            try
            {
                //Get process times
