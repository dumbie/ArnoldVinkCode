...
{
    public partial class AVShellInfo
    {
        //Imports
        [DllImport("shell32", CharSet = CharSet.Unicode, PreserveSig = false)]
        private static extern string SHGetKnownFolderPath(Guid rfid, uint dwFlags, uint hToken);
        ...
        public static class KnownFolder
        {
            ...
            public static readonly Guid AppModsAll = Guid.Parse("7AD67899-66AF-43BA-9156-6AAD42E6C596");
            public static readonly Guid AppModsCurrent = Guid.Parse("3DB40B20-2A30-4DBE-917E-771DD21DD099");
            ...
            public static readonly Guid Apps = Guid.Parse("1E87508D-89C2-42F0-8A7E-645A0F50CA58");
            ...
            public static readonly Guid Computer = new Guid("0AC0837C-BBF8-452A-850D-79D08E667CA7");
            public static readonly Guid Conflict = new Guid("4BFEFB45-347D-4006-A5BE-AC0CB0567192");
            public static readonly Guid Connections = Guid.Parse("6F0CD92B-2E97-45D1-88FF-B0D186B8DEDD");
            public static readonly Guid Contacts = Guid.Parse("56784854-C6CB-462B-8169-88E350ACB882");
            public static readonly Guid ControlPanel = Guid.Parse("82A74AEB-AEB4-465C-A014-D097EE346D63");
            public static readonly Guid Cookies = Guid.Parse("2B0F765D-C0E9-4171-908E-08A611B84FF6");
            public static readonly Guid CredentialManager = Guid.Parse("915221FB-9EFE-4BDA-8FD7-F78DCA774F87");
            public static readonly Guid CryptoKeys = Guid.Parse("B88F4DAA-E7BD-49A9-B74D-02885A5DC765");
            ...
            public static readonly Guid DpapiKeys = Guid.Parse("10C07CD0-EF91-4567-B850-448B77CB37F9");
            ...
            public static readonly Guid Internet = Guid.Parse("4D9F7874-4E0C-4904-967B-40B0D20C3E4B");
            ...
            public static readonly Guid LocalStorage = Guid.Parse("B3EB08D3-A1F3-496B-865A-42B536CDA0EC");
            ...
            public static readonly Guid Network = Guid.Parse("D20BEEC4-5CA8-4905-AE3B-BF251EA09B53");
            ...
            public static readonly Guid OneDriveCameraRoll = Guid.Parse("767E6811-49CB-4273-87C2-20F355E1085B");
            public static readonly Guid OneDriveDocuments = Guid.Parse("24D89E24-2F19-4534-9DDE-6A6671FBB8FE");
            public static readonly Guid OneDriveMusic = Guid.Parse("C3F2459E-80D6-45DC-BFEF-1F769F2BE730");
            public static readonly Guid OneDrivePictures = Guid.Parse("339719B5-8C47-4894-94C2-D8F77ADD44A6");
            ...
            public static readonly Guid Printers = Guid.Parse("76FC4E2D-D6AD-4519-A663-37BD56068185");
            ...
            public static readonly Guid RecordedTV = Guid.Parse("BD85E001-112E-431E-983B-7B15AC09FFF1");
            public static readonly Guid RecordedTVLibrary = Guid.Parse("1A6FDBA2-F42D-4358-A798-B74D745926C5");
            public static readonly Guid RecycleBin = Guid.Parse("B7534046-3ECB-4C18-BE4E-64CD4CB7D6AC");
            ...
            public static readonly Guid SearchCsc = Guid.Parse("EE32E446-31CA-4ABA-814F-A5EBD2FD6D5E");
            ...
            public static readonly Guid SearchMapi = Guid.Parse("98EC0E18-2098-4D44-8644-66979315A281");
            ...
            public static readonly Guid SyncManager = Guid.Parse("43668BF8-C14E-49B2-97C9-747784D784B7");
            public static readonly Guid SyncResults = Guid.Parse("289A9A43-BE44-4057-A41B-587A76D7E7F9");
            public static readonly Guid SyncSetup = Guid.Parse("0F214138-B1D3-4A90-BBA9-27CBC0C5389A");
            public static readonly Guid System = Guid.Parse("1AC14E77-02E7-4E5D-B744-2EB1AE5198B7");
            public static readonly Guid SystemCertificates = Guid.Parse("54EED2E0-E7CA-4FDB-9148-0F4247291CFA");
            ...
            public static readonly Guid ThisPCDesktop = Guid.Parse("754AC886-DF64-4CBA-86B5-F7FBF4FBCEF5");
            public static readonly Guid TreeProperties = Guid.Parse("5B3749AD-B49F-49C1-83EB-15370FBD4882");
        ...
        //Functions
        public static string ShellPath_SpecialFolder(SpecialFolder specialFolder)
        {
            try
            {
        ...
        public static string ShellPath_KnownFolder(Guid knownFolder)
        {
            try
            {
                return SHGetKnownFolderPath(knownFolder, 0, 0);
            }
            catch
            {
                return string.Empty;
